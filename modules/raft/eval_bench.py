"""
Baseline RAFT benchmark evaluation.
Runs Sintel validation with timing and outputs JSON results.
"""
import sys
...
def main():
    ...
    # Warm-up
    print("Warming up ...")
    dummy1 = torch.randn(1, 3, 440, 1024, device='cuda')
    dummy2 = torch.randn(1, 3, 440, 1024, device='cuda')
    with torch.no_grad():
        for _ in range(3):
